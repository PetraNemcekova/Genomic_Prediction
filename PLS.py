...
met_train, met_test, gen_train, gen_test = train_test_split(met_arr, gen_arr, test_size = 0.4,random_state=0)
...
pls.fit(gen_train, met_train)
met_pred = pls.predict(gen_test) 
